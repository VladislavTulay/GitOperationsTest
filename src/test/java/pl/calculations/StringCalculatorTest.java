...
public class StringCalculatorTest {
    ...
    public void should_throw_IllegalArgumentException_when_passed_string_is_not_a_number() {
        org.junit.jupiter.api.Assertions.assertThrows(IllegalArgumentException.class, () -> stringCalculator.add(",1,s,3"));
    }

    @Test()
    @Tag("Smoke")
    public void should_throw_IllegalArgumentException_when_passed_string_has_comma_as_a_first_character() {
        org.junit.jupiter.api.Assertions.assertThrows(IllegalArgumentException.class, () -> stringCalculator.add(",1,2,3"));
    }
    ...
    public void should_throw_IllegalArgumentException_when_passed_string_has_duplicated_commas() {
        org.junit.jupiter.api.Assertions.assertThrows(IllegalArgumentException.class, () -> stringCalculator.add("1,,3"));
    }
    ...
    public void should_throw_NumberFormatException_when_delimiter_specification_is_separated_by_every_char_but_not_new_line() {
        org.junit.jupiter.api.Assertions.assertThrows(NumberFormatException.class, () -> stringCalculator.add("//;\t3;2;4"));
    }
